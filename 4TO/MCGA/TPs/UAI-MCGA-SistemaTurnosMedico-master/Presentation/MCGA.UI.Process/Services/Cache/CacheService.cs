...
namespace WebApplication1.Services.Cache
{
    public static class DataCacheSetting
    {
        public static class Clasificador
        {
            public const string Key = "Clasificador";
    ...
    public class DataCache
    {
        ...
        public List<string> ClasificadorList()
        {
            var lista = _cacheService.GetOrAdd(DataCacheSetting.Clasificador.Key, () =>
             {
